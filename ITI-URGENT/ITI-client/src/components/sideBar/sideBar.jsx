...
// assets import
import ITI_Logo from "./assets/Layer_1.svg";
...
function SideBar({
    ...
    const truncatedName = words?.slice(0, 7).join(' ') + (words?.length > 7 ? '...' : '');
                ...
                <div>
                    <div className={styles.navPage__items}>
                        <div>
                            ...
                            >
                                <svg className={styles.svgDimension} viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path id={styles.displayCenter} d="M12.4987 13C11.5782 13 10.832 13.7462 10.832 14.6667V17.1667C10.832 18.0872 11.5782 18.8333 12.4987 18.8333H12.5187C13.5629 18.8333 14.459 18.7785 15.2077 18.6121C15.9659 18.4436 16.6232 18.1498 17.1359 17.6372C17.6485 17.1245 17.9423 16.4672 18.1108 15.709C18.1872 15.3652 18.2376 15.0162 18.2707 14.6649C18.3571 13.7485 17.5859 13 16.6654 13H12.4987Z" fill="#0E0E0F" />
                                    <path id={styles.displayCenter} d="M1.66602 13.0203V11.3337C1.66602 10.4132 2.41221 9.66699 3.33268 9.66699H7.49935C8.41985 9.66699 9.16602 10.4132 9.16602 11.3337V17.167C9.16602 18.0875 8.41985 18.8337 7.49935 18.8337H7.47935C6.43507 18.8337 5.53903 18.7788 4.79031 18.6124C4.03212 18.4439 3.37489 18.1502 2.86221 17.6375C2.34952 17.1248 2.05578 16.4676 1.88728 15.7093C1.72088 14.9607 1.66602 14.0646 1.66602 13.0203Z" fill="#0E0E0F" />
                                    <path id={styles.displayCenter} d="M18.332 9.66699C18.332 10.5875 17.5859 11.3337 16.6654 11.3337H12.4987C11.5782 11.3337 10.832 10.5875 10.832 9.66699V3.83366C10.832 2.91318 11.5782 2.16699 12.4987 2.16699H12.5187C13.5629 2.16699 14.459 2.22186 15.2077 2.38826C15.9659 2.55676 16.6232 2.8505 17.1359 3.36318C17.6485 3.87587 17.9423 4.5331 18.1108 5.29128C18.2772 6.04001 18.332 6.93605 18.332 7.98033V9.66699Z" fill="#0E0E0F" />
                                    <path id={styles.displayCenter} d="M9.16602 3.83366C9.16602 2.91318 8.41985 2.16699 7.49935 2.16699H7.47935C6.43508 2.16699 5.53904 2.22186 4.79031 2.38826C4.03213 2.55676 3.3749 2.8505 2.86221 3.36318C2.34953 3.87587 2.05579 4.5331 1.88729 5.29128C1.81086 5.63516 1.76043 5.98418 1.72732 6.33541C1.64095 7.25183 2.41221 8.00033 3.33269 8.00033H7.49935C8.41985 8.00033 9.16602 7.25413 9.16602 6.33366V3.83366Z" fill="#0E0E0F" />
                                </svg>
                        ...
                        <div>
                            ...
                            >
                                <svg className={styles.svgDimension} viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path id={styles.sales} d="M9.99935 11.6836C8.50768 11.6836 7.29102 12.9003 7.29102 14.3919V19.1836H12.7077V14.3919C12.7077 12.9003 11.491 11.6836 9.99935 11.6836Z" fill="#0E0E0F" />
                                    <path id={styles.sales} d="M17.6243 6.46712L11.791 2.38379C10.716 1.63379 9.27435 1.63379 8.20768 2.38379L2.37435 6.46712C1.54102 7.05046 1.04102 8.00879 1.04102 9.02546V16.0588C1.04102 17.7838 2.44102 19.1838 4.16602 19.1838H6.04102V14.3921C6.04102 12.2088 7.81602 10.4338 9.99935 10.4338C12.1827 10.4338 13.9577 12.2088 13.9577 14.3921V19.1838H15.8327C17.5577 19.1838 18.9577 17.7838 18.9577 16.0588V9.02546C18.9577 8.00879 18.4577 7.05046 17.6243 6.46712Z" fill="#0E0E0F" />
                                </svg>
                                <label className={styles.pointer}>
                                    Sales
                                </label>
                        ...
                        <div>
                            <div
                                className={cx(
                                    ...
                                    styles.settings,
                                    {
                                        [styles.settingsActive]: ["settings", "help", "terms"].includes(active),
                                    }
                                )}
                            ...
                            >
                                <svg className={styles.svgDimension} viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_2125_331)">
                                        <mask id="mask0_2125_331" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="21">
                                            <path id={styles.inbox} d="M0 0.5H20V20.5H0V0.5Z" fill="white" />
                                        </mask>
                                        <g mask="url(#mask0_2125_331)">
                                            <path id={styles.inbox} d="M17.5703 4.66992L12.4864 8.86668C11.0427 10.0584 8.95655 10.0584 7.51284 8.86668L2.42898 4.66992C2.34104 4.5973 1.82149 4.18357 1.22656 3.71209C1.92596 3.05263 2.8687 2.64844 3.90585 2.64844H16.0933C17.1081 2.64844 18.0324 3.03536 18.7269 3.66971C18.6445 3.74116 18.5645 3.81054 18.4876 3.87725C17.9971 4.30242 17.6319 4.61898 17.5703 4.66992Z" fill="#0E0E0F" />
                                            <path id={styles.inbox} d="M19.3619 4.41406L13.1831 9.70992C11.3352 11.2354 8.66489 11.2354 6.81696 9.70992L0.557597 4.54199C0.306817 4.9584 0 5.2702 0 5.79836V14.4466C0 16.604 1.74889 18.3529 3.90626 18.3529H16.0938C18.1163 18.3529 19.7798 16.8158 19.9799 14.8461C19.9932 14.7147 20 14.5815 20 14.4466V5.79836C20 5.24113 19.6491 4.8516 19.3619 4.41406Z" fill="#0E0E0F" />
                                        </g>
                                    </g>
                                    <defs>
                    ...
                    <div className={cx(styles.profile, styles.pointer)}>
                        <p className={styles.displayActive}
                            onClick={() => {
                                localStorage.clear()
                                localStorage.clear()
                                navigate("/signin")
                        ...
                        <svg
                            ...
                            className={cx(styles.displayActive, styles.svgDimension)} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg
                            ...
                            className={cx(styles.displayNone, styles.absright, styles.svgDimension)} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16 17L21 12M21 12L16 7M21 12H9M9 3H7.8C6.11984 3 5.27976 3 4.63803 3.32698C4.07354 3.6146 3.6146 4.07354 3.32698 4.63803C3 5.27976 3 6.11984 3 7.8V16.2C3 17.8802 3 18.7202 3.32698 19.362C3.6146 19.9265 4.07354 20.3854 4.63803 20.673C5.27976 21 6.11984 21 7.8 21H9" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                </div>
