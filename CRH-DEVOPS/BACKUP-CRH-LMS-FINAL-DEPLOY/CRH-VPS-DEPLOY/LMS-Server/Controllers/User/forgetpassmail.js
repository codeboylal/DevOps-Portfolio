...
const sendMail = async (name, email, content) => {
    var mailOptions = {
        ...
        html: `
            <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
                ...
                <p>Below is the message he sent you:</p>
                <p style="background-color: #f9f9f9; padding: 10px; border: 1px solid #ddd; border-radius: 5px;">
                    Query: ${content}
                </p>
                <br />
                <p style="font-size: 12px; color: #999;">Suggestion<br/>Feedback</p>
                <br/>
                <p>
                    will be here if there are any
                </p>
            </div>
        `
    };
