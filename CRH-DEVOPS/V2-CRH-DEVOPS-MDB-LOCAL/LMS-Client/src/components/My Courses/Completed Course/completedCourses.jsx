...
//       axios.get(`http://localhost:5000/api/goToCourses/${id}/courses`)
//         .then((response) => {
//           const filteredCourses = response.data.filter(course => {
//             const [completed, total] = course.lessons.split('/').map(Number);
//             return completed === total; // Only include fully completed courses
//           });
//           setGoToCourses(filteredCourses);
//         });

//       // Fetch startable courses
//       axios.get(`http://localhost:5000/api/startCourses/user/${id}/courses`)
//         .then((response) => {
...
//         });
  ...
  //     axios.get(`http://localhost:5000/api/progressCourse/${id}/course`)
  //       .then((response) => {
