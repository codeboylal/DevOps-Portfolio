...
// function StatusFilter({ setSelectedStatus, closePopup }) {
...
//   // Retrieve the stored status from localStorage or set "In Progress" as default
//   const storedStatus = localStorage.getItem("selectedStatus") || "In Progress";

//   // Initialize status state based on stored status
//   const [statusFilter, setStatusFilter] = useState(
//     initialStatusFilter.map((item) => ({
//       ...item,
//       value: item.label === storedStatus,
//     }))
//   );
...
//     const selectedLabel = statusFilter[indexToUpdate].label;
...
//     // Save selected status in localStorage
//     localStorage.setItem("selectedStatus", selectedLabel);
...
function StatusFilter({ setSelectedStatus, closePopup }) {
  ...
  //   setStatusFilter((prevStatusFilter) =>
  //     prevStatusFilter.map((item, index) =>
  //       index === indexToUpdate ? { ...item, value: !item.value } : item
  //     )
  //   );
  ...
  //   // Save selected statuses in localStorage
  //   localStorage.setItem("selectedStatus", JSON.stringify(selectedStatuses));
