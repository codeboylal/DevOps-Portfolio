...
import qualityInclusion from "./SVGS/quality inclusion.svg";
  ...
  const cards = [
    {
      icon: contractorIcon,
      title: "Contractor Contacts",
      description: "View and manage contractor contacts for your project",
      onClick: () => navigate("/contractor"), 
    },
    // {
    //   icon: signatureIcon,
    //   title: "Signature Template",
    //   description: "Manage email signature templates for outgoing emails.",
    // },
    // {
    //   icon: quotationIcon,
    //   title: "Quotation Template",
    //   description: "Create and manage quotation templates for use in Sales.",
    // },
    // {
    //   icon: quotationIcon,
    //   title: "Addons Template",
    //   description: "Manage add-on templates for individual line items in quotations.",
    // },
    // {
    //   icon: qualityInclusion,
    //   title: "Quality Inclusion Template",
    //   description: "Create and manage quality inclusion templates for merging into the PDF.",
    // },
    // {
    //   icon: accountsIcon,
    //   title: "Accounts",
