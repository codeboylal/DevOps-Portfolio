...
const Signup = ({ loginModel = false, setLoginModel, closeSignup, setSignUpModel, signUpModel }) => {
    ...
    >
      ...
      >
        <IconButton
          ...
          onClick={() => { setSignUpModel(false); document.body.style.overflowY = "scroll" }} // Redirect to homepage
        >
          <Close />
        </IconButton>
        ...
        >
          ...
          >
            Already a member?{' '}
            <Link onClick={() => { setSignUpModel(false); setLoginModel(true) }} underline="none" sx={{ color: '#FF702D', fontWeight: 'bold', cursor: 'pointer', }}>
              Login
            </Link>
          </Typography>
        </Box>
      </Box>
      {/* <LoginPopUP loginModel={setLoginModel}  setLoginModel={setLoginModel}/> */}
    </Box>
  );
};
